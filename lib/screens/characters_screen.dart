  ...
  Widget build(BuildContext context) {
    ...
    final List<AccountCharacterData> list = [
      ...charactersProvider.onDisplayCharacters.map((e) {
        List<AccountCharacter> filteredAccountCharacters = accountCharacters
            .where((element) => element.characterId == e.id)
            .toList();
        if (filteredAccountCharacters.isEmpty) {
          return AccountCharacterData(
              character: e, isBuilding: false, isPulled: false);
        } else {
          ...
          return AccountCharacterData(
              ...
              elementalTalentLevel:
                  accountCharacter.elementalTalentLevel.toString(),
