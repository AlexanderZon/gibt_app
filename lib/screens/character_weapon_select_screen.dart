...
class CharacterWeaponSelectScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final aaccountCharactersProvider = Provider.of<AccountCharactersProvider>(context, listen: true); 
  
    final AccountCharacter accountCharacter = ModalRoute.of(context)!.settings.arguments as AccountCharacter;
