...
class MaterialItem {
  ...
  factory MaterialItem.fromRawJson(String str) =>
      MaterialItem.fromJson(json.decode(str));
  ...
  factory MaterialItem.fromJson(Map<String, dynamic> json) {
    return MaterialItem(
      ...
      weekdays: List<Weekday>.from(
          json["weekdays"].map((x) => weekdayValues.map[x]!)),
    );
  }
  ...
  Map<String, dynamic> toJson() => {
        ...
        "weekdays":
            List<dynamic>.from(weekdays.map((x) => weekdayValues.reverse[x])),
      };
}
...
enum AscensionMaterialType {
  ...
  BOSS_ITEM,
  REWARD_ITEM,
  PRIMARY_ASCENSION_MATERIAL,
  SECONDARY_ASCENSION_MATERIAL
}
